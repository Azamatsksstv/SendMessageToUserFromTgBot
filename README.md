...
## Указываем в хедерах токен для авторизации, также message прописываем сообщение
![image](https://github.com/Azamatsksstv/SendMessageToUserFromTgBot/assets/90980633/536c0069-302e-455f-9524-4514b300e5ca)
## Получаем сообщение от бота
![image](https://github.com/Azamatsksstv/SendMessageToUserFromTgBot/assets/90980633/005c4520-9876-48fb-afac-e6b223e09f29)
